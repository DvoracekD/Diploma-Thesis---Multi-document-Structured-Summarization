...
\caption/f Changes in individual metrics. In all charts, the horizontal axis shows the order of improvement iterations, and the vertical axis shows the value of the metric. The bottom row presents the metrics calculated on individual datasets (media cases). In the lower left corner, the overall aggregated values of the tracked metrics are located. In the rest of the bottom row, the metrics calculated for individual evaluation phases are presented.
\medskip
