...
This chapter provides a critical analysis of experimental results obtained in the preceding sections. The aim is to interpret model performance, assess the impact of pipeline improvements, and evaluate alternative inference strategies. Each section addresses a key aspect of system development and presents findings in the context of statistical rigor and practical relevance.

The first section, summarizes the comparative evaluation of all tested models and pipeline versions. It highlights main performance trends, focusing on the strengths and weaknesses of commercial versus open-source models, as visualized in comprehensive heatmaps.

The second section, investigates whether iterative prompt and pipeline refinements yield measurable benefits. This section describes the methodology for comparing baseline and improved solutions, presents summary statistics, and applies formal statistical tests to determine the significance of observed changes.

The third section, examines the effect of processing articles individually rather than in batches. It compares the single-article and multi-article strategies using the same rigorous statistical framework, presenting both quantitative results and their visual interpretation.
