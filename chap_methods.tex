...
The described script serves as a helper tool. The resulting structure is finally checked and edited by a human annotator, who verifies that appropriate entities and events were connected and that relational links correspond to reality.
...
\picw=10cm \cinspic figs/mlflow/run-detail.png
...
\picw=14cm \cinspic figs/mlflow/run-artifacts.png
...
\medskip  \clabel[prompt-management]{MLflow prompt management}
