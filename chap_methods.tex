...
\caption/f An overview diagram of the individual phases of the extraction pipeline process. The individual subprocesses are described in detail in this chapter. Individual blocs represent the individual subprocesses. The arrows symbolize data passing (output to input).
\medskip
