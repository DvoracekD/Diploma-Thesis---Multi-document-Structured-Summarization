...
{\it Plotly}\cite[plotly] was used to generate all plots and visualizations in the thesis. This library facilitated the creation of interactive and publication-quality charts, which were essential for communicating experimental findings and for comparing the performance of various models and pipeline configurations. Visualizations created using Plotly provided intuitive insights into metric distributions and experimental trends.
